// User level curve — mirrors backend/src/leveling.ts. Level 1 starts at 0 XP; each
// level requires progressively more XP than the last, capped at MAX_LEVEL. Keep
// both files in sync if the curve changes.
